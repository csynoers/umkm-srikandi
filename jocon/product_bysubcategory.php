				<section class="main-content col-lg-6 col-md-6 col-sm-6 col-lg-push-3 col-md-push-3 col-sm-push-3">
					...
					<div class="row"> 
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="carousel-heading">
                                <h4>Menampilkan Produk Berdasarkan Subkategori</h4>
                            </div>
					...
					<?php
						...
						$homeproduk = mysql_query("SELECT * FROM produk WHERE id_subkategori='$_GET[id]' ORDER BY id_produk DESC LIMIT $posisi, $batas");
					...
					?>
						...
						<?php $jmldata     = mysql_num_rows(mysql_query("SELECT * FROM produk  WHERE id_subkategori='$_GET[id]'"));
							if($jmldata > 9){
						?>
                        <div class="col-lg-12 col-md-12 col-sm-12">
