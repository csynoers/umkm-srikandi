...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_howtoorder/aksi_howtoorder.php";
				$howtoorder = mysql_query("SELECT * FROM modul WHERE id_modul='7'");
				$w=mysql_fetch_array($howtoorder);
				?>
		
		<article class="module width_full">
			<header><h3>Edit How To Order</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=howtoorder&act=update'>
