...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_tos/aksi_tos.php";
				$tos = mysql_query("SELECT * FROM modul WHERE id_modul='5'");
				$w=mysql_fetch_array($tos);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Join Reseller</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=tos&act=update'>
