...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_faqs/aksi_faqs.php";
				$faqs = mysql_query("SELECT * FROM modul WHERE id_modul='4'");
				$w=mysql_fetch_array($faqs);
				?>
		
		<article class="module width_full">
			<header><h3>Edit FAQ's</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=faqs&act=update'>
