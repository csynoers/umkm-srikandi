...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_technologys/aksi_technologys.php";
				$profil = mysql_query("SELECT * FROM modul WHERE id_modul='3'");
				$w=mysql_fetch_array($profil);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Technologys</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=technologys&act=update'>
